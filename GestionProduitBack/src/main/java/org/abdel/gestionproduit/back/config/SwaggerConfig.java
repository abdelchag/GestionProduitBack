package org.abdel.gestionproduit.back.config;

import org.abdel.gestionproduit.back.services.ProduitService;
...
@ComponentScan(basePackageClasses = ProduitService.class)
@Configuration
public class SwaggerConfig {
    ...
    @Bean
    public Docket gestionProduitAPI(){
